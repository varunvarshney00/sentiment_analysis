...
# Main Application
def main():
    st.title("EmoNet - Emotion Detection App")
    ...
    if choice == "Home":
        ...
        appli1_text = st.markdown(
            "1. Customer Service: Emotion detection can be used in customer service settings to analyze customer feedback, such as emails or social media posts, to determine the emotional tone of the customer's message. This information can be used to identify customer needs and improve customer satisfaction. ")
        appli2_text = st.markdown(
            "2. Market Research: Emotion detection can be used in market research to analyze consumer feedback on new products or services. By understanding the emotional response to a new product or service, companies can make better decisions about product development and marketing strategies.")
        appli3_text = st.markdown(
            "3. Mental Health: Emotion detection can be used in mental health settings to identify and monitor changes in a patient's emotional state over time. This information can be used to inform treatment decisions and improve patient outcomes.")
        appli4_text = st.markdown(
            "4. Education: Emotion detection can be used in educational settings to analyze student feedback and identify areas where students may be struggling emotionally. This information can be used to provide additional support and resources to students as needed.")
        appli5_text = st.markdown(
            "5. Social Media: Emotion detection can be used to monitor social media platforms for trends and patterns in emotional content. This information can be used by marketers, politicians, or other groups to identify and respond to changes in public opinion or sentiment.")
